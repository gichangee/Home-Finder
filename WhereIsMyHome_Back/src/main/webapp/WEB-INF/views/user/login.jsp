...
<body>
							...
							<form id="LoginForm" data-sb-form-api-token="API_TOKEN"
								...
								<div class="form-floating mb-3">
									<input class="form-control" name="user_password"
										id="user_password" type="password" placeholder="*****" /> <label
										for="user_password">Password</label>
									<div class="invalid-feedback">A Password is required.</div>
								</div>

								<input type="checkbox" id="idSaveCheck" name="idSaveCheck"> <label
									for="remember">아이디 저장</label><br>
								<!-- Submit Button-->
								<div class="d-grid">
									<button class="btn btn-primary btn-lg" id="submitButton"
										type="submit">로그인하기</button>
									<br>
	...
	<script>
document.querySelector("#findpassword").addEventListener("click", function (event) {
